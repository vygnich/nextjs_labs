...
export default function ATCButton(product: Product){
    ...
    const [waitingStatus, setWaitingStatus] = useState<Boolean>(false)
    ...
    return (
        <button onClick={handleATC}
            ...
            {
                waitingStatus ?
                    <svg aria-hidden="true" className="w-2 h-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
